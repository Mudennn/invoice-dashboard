        ...
        <table class="table table-bordered table-hover">
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="text-end">RM{{ isset($debit_note->debitItems) ? number_format($debit_note->debitItems->sum('excluding_tax'), 2) : '0.00' }}</td>
                </tr>
                <tr>
                    <td colspan="5" class="text-end"><strong>Tax Amount</strong></td>
                    <td class="text-end">RM{{ isset($debit_note->debitItems) ? number_format($debit_note->debitItems->sum('tax_amount'), 2) : '0.00' }}</td>
                </tr>
                <tr>
                    <td colspan="5" class="text-end"><strong>Subtotal</strong></td>
                    <td class="text-end">RM{{ isset($debit_note->debitItems) ? number_format($debit_note->debitItems->sum('excluding_tax') + $debit_note->debitItems->sum('tax_amount'), 2) : '0.00' }}</td>
                </tr>
                <tr>
                    <td colspan="5" class="text-end"><strong>TOTAL</strong></td>
                    <td class="text-end fw-bold">RM{{ isset($debit_note->debitItems) ? number_format($debit_note->debitItems->sum('excluding_tax') + $debit_note->debitItems->sum('tax_amount'), 2) : '0.00' }}</td>
                </tr>
            </tfoot>
        </table>
    </div>
