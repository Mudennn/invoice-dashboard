@extends('layouts.dashboard', ['title' => 'Receipts'])

@section('content')
    <div style="padding: 40px;">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="text-2xl font-bold">Taxes</h2>
            <a href="{{ route('taxes.create') }}" class="primary-button">Create</a>
        </div>
            ...
            <table class="table table-hover table-bordered align-middle text-nowrap" id="invoiceTable">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th scope="col" style="width: 3%;" class="text-center">Tax Code</th>
                        <th scope="col" style="width: 10%;">Tax Type</th>
                        <th scope="col" style="width: 3%;" class="text-center">Tax Rate</th>
                ...
                <tbody>
                    @foreach ($taxes as $index => $tax)
                        <tr>
                            ...
                            <td>{{ $tax->tax_type }}</td>
                            <td class="text-center">{{ $tax->tax_rate }}%</td>
                            <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu w-50" aria-labelledby="dropdownMenuButton1">
                                        <li><a href="{{ route('taxes.edit', $tax->id) }}" class="dropdown-item"
                                                href="#"
                                        ...
                                        <li><a href="{{ route('taxes.destroy', $tax->id) }}"
