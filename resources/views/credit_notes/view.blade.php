...
<div class="form-input-container">
    <div class="table-responsive">
        <table class="table table-bordered table-hover">
            ...
            <tfoot>
                <tr>
                    <td colspan="5" class="text-end"><strong>Tax Excluded</strong></td>
                    <td class="text-end">RM{{ isset($credit_note->creditItems) ? number_format($credit_note->creditItems->sum('excluding_tax'), 2) : '0.00' }}</td>
                </tr>
                <tr>
                    <td colspan="5" class="text-end"><strong>Tax Amount</strong></td>
                    <td class="text-end">RM{{ isset($credit_note->creditItems) ? number_format($credit_note->creditItems->sum('tax_amount'), 2) : '0.00' }}</td>
                </tr>
                <tr>
                    <td colspan="5" class="text-end"><strong>Subtotal</strong></td>
                    <td class="text-end">RM{{ isset($credit_note->creditItems) ? number_format($credit_note->creditItems->sum('excluding_tax') + $credit_note->creditItems->sum('tax_amount'), 2) : '0.00' }}</td>
                </tr>
                <tr>
                    <td colspan="5" class="text-end"><strong>TOTAL</strong></td>
                    <td class="text-end fw-bold">RM{{ isset($credit_note->creditItems) ? number_format($credit_note->creditItems->sum('excluding_tax') + $credit_note->creditItems->sum('tax_amount'), 2) : '0.00' }}</td>
                </tr>
            </tfoot>
        </table>
    </div>
