        ...
        <table class="table table-bordered table-hover">
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="text-end">RM{{ isset($self_billed_invoice->selfBilledInvoiceItems) ? number_format($self_billed_invoice->selfBilledInvoiceItems->sum('amount'), 2) : '0.00' }}</td>
                </tr>
                <tr>
                    <td colspan="4" class="text-end"><strong>TOTAL</strong></td>
                    <td class="text-end fw-bold">RM{{ isset($self_billed_invoice->selfBilledInvoiceItems) ? number_format($self_billed_invoice->selfBilledInvoiceItems->sum('amount'), 2) : '0.00' }}</td>
                </tr>
            </tfoot>
        </table>
    </div>
