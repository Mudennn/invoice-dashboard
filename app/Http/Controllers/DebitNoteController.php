...
class DebitNoteController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('debit_notes.create', compact('debit_note', 'invoices', 'customers', 'reasons', 'ro'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('debit_notes.edit', compact('debit_note', 'invoices', 'customers', 'reasons', 'ro', 'subtotal'));
    }
    ...
    public function show($id)
    {
        ...
        return view('debit_notes.show', compact('debit_note', 'subtotal', 'reasons', 'customers', 'states', 'ro'));
    }
